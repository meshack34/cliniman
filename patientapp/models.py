...
class ChiefComplaint(models.Model):
    patient = models.ForeignKey('Patient', on_delete=models.CASCADE, related_name='chief_complaints')
    chief_complaint_text = models.TextField()
    history_presenting_complaint_text = models.TextField()  # Correct indentation here
    timestamp = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f'Chief Complaint for {self.patient.user.first_name} {self.patient.user.last_name}'

from django.db import models

class HospitalHistory(models.Model):
    patient = models.ForeignKey('Patient', on_delete=models.CASCADE, related_name='hospital_histories')
    ...
    timestamp = models.DateTimeField(auto_now_add=True)
    def __str__(self):
        return f'Hospital History for {self.patient.user.first_name} {self.patient.user.last_name}'


class Examination(models.Model):
    # Choices for different types of examinations
    ...
    examination_name = models.CharField(max_length=100, choices=EXAM_CHOICES)
    description = models.TextField()
    date = models.DateField()
    timestamp = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f'{self.get_examination_name_display()} - {self.patient.user.first_name} {self.patient.user.last_name}'
...
class Investigations(models.Model):
    ...
    def __str__(self):
        return f'{self.investigation_name} - {self.patient.user.first_name} {self.patient.user.last_name}'
...
class Vitals(models.Model):
    ...
    def __str__(self):
        return f'{self.vital_name} - {self.patient.user.first_name} {self.patient.user.last_name}'
...
class LabTest(models.Model):
    # Choices for different types of lab tests
    ...
    date = models.DateField()
    file_upload = models.FileField(upload_to='lab_test_files/', blank=True, null=True)
    timestamp = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f'{self.get_test_name_display()} - {self.patient.user.first_name} {self.patient.user.last_name}'
