...
urlpatterns = [
    ...
    path('patient/<int:patient_id>/add_chief_complaint/', views.add_chief_complaint, name='add_chief_complaint'),
    path('myconsoltantpage/', views.myconsoltantpage, name='myconsoltantpage'),
    
    path('patient_list/', views.patients_doctorlist, name='patients_doctorlist'),
    path('enter_chief_complaint/<int:patient_id>/', views.enter_chief_complaint, name='enter_chief_complaint'),
    path('enter_hospital_history/<int:patient_id>/', views.enter_hospital_history, name='enter_hospital_history'),
    #
]
